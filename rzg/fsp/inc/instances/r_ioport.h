...
{
    IOPORT_NOISE_FILTER_IRQ_P00_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_P01_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_P02_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_P03_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_P04_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_P05_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_P06_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_P07_OFFSET = 0x18, /* IRQ12 */

    IOPORT_NOISE_FILTER_IRQ_P10_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_P11_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_P12_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_P13_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_P14_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_P15_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_P16_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_P17_OFFSET = 0x08, /* IRQ4 */

    IOPORT_NOISE_FILTER_IRQ_P20_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_P21_OFFSET = 0x18, /* IRQ12 */

    IOPORT_NOISE_FILTER_IRQ_P30_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_P31_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_P32_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_P33_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_P34_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_P35_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_P36_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_P37_OFFSET = 0x08, /* IRQ4 */

    IOPORT_NOISE_FILTER_IRQ_P40_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_P41_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_P42_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_P43_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_P44_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_P45_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_P46_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P47_OFFSET = 0x00,

    IOPORT_NOISE_FILTER_IRQ_P50_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_P51_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_P52_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_P53_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_P54_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_P55_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_P56_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_P57_OFFSET = 0x00,

    IOPORT_NOISE_FILTER_IRQ_P60_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_P61_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_P62_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_P63_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_P64_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_P65_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_P66_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_P67_OFFSET = 0x00,

    IOPORT_NOISE_FILTER_IRQ_P70_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_P71_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_P72_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_P73_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_P74_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_P75_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_P76_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_P77_OFFSET = 0x1C, /* IRQ14 */

    IOPORT_NOISE_FILTER_IRQ_P80_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_P81_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_P82_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_P83_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_P84_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_P85_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_P86_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P87_OFFSET = 0x00,

    IOPORT_NOISE_FILTER_IRQ_P90_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P91_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P92_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P93_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P94_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P95_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P96_OFFSET = 0x00,
    IOPORT_NOISE_FILTER_IRQ_P97_OFFSET = 0x00,

    IOPORT_NOISE_FILTER_IRQ_PA0_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_PA1_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_PA2_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_PA3_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_PA4_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_PA5_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_PA6_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_PA7_OFFSET = 0x04, /* IRQ2 */

    IOPORT_NOISE_FILTER_IRQ_PB0_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_PB1_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_PB2_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_PB3_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_PB4_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_PB5_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_PB6_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_PB7_OFFSET = 0x14, /* IRQ10 */

    IOPORT_NOISE_FILTER_IRQ_PC0_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_PC1_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_PC2_OFFSET = 0x04, /* IRQ2 */

    IOPORT_NOISE_FILTER_IRQ_PD0_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_PD1_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_PD2_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_PD3_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_PD4_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_PD5_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_PD6_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_PD7_OFFSET = 0x14, /* IRQ10 */

    IOPORT_NOISE_FILTER_IRQ_PE0_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_PE1_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_PE2_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_PE3_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_PE4_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_PE5_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_PE6_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_PE7_OFFSET = 0x18, /* IRQ12 */

    IOPORT_NOISE_FILTER_IRQ_PF0_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_PF1_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_PF2_OFFSET = 0x1E, /* IRQ15 */

    IOPORT_NOISE_FILTER_IRQ_PG0_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_PG1_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_PG2_OFFSET = 0x16, /* IRQ11 */
    IOPORT_NOISE_FILTER_IRQ_PG3_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_PG4_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_PG5_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_PG6_OFFSET = 0x1E, /* IRQ15 */
    IOPORT_NOISE_FILTER_IRQ_PG7_OFFSET = 0x00, /* IRQ0 */

    IOPORT_NOISE_FILTER_IRQ_PH0_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_PH1_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_PH2_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_PH3_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_PH4_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_PH5_OFFSET = 0x0C, /* IRQ6 */

    IOPORT_NOISE_FILTER_IRQ_PJ0_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_PJ1_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_PJ2_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_PJ3_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_PJ4_OFFSET = 0x10, /* IRQ8 */

    IOPORT_NOISE_FILTER_IRQ_PK0_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_PK1_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_PK2_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_PK3_OFFSET = 0x14, /* IRQ10 */

    IOPORT_NOISE_FILTER_IRQ_PL0_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_PL1_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_PL2_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_PL3_OFFSET = 0x06, /* IRQ3 */
    IOPORT_NOISE_FILTER_IRQ_PL4_OFFSET = 0x18, /* IRQ12 */
    IOPORT_NOISE_FILTER_IRQ_PL5_OFFSET = 0x1A, /* IRQ13 */
    IOPORT_NOISE_FILTER_IRQ_PL6_OFFSET = 0x1C, /* IRQ14 */
    IOPORT_NOISE_FILTER_IRQ_PL7_OFFSET = 0x1E, /* IRQ15 */

    IOPORT_NOISE_FILTER_IRQ_PM0_OFFSET = 0x08, /* IRQ4 */
    IOPORT_NOISE_FILTER_IRQ_PM1_OFFSET = 0x0A, /* IRQ5 */
    IOPORT_NOISE_FILTER_IRQ_PM2_OFFSET = 0x0C, /* IRQ6 */
    IOPORT_NOISE_FILTER_IRQ_PM3_OFFSET = 0x0E, /* IRQ7 */
    IOPORT_NOISE_FILTER_IRQ_PM4_OFFSET = 0x10, /* IRQ8 */
    IOPORT_NOISE_FILTER_IRQ_PM5_OFFSET = 0x12, /* IRQ9 */
    IOPORT_NOISE_FILTER_IRQ_PM6_OFFSET = 0x14, /* IRQ10 */
    IOPORT_NOISE_FILTER_IRQ_PM7_OFFSET = 0x16, /* IRQ11 */

    IOPORT_NOISE_FILTER_IRQ_PS0_OFFSET = 0x00, /* IRQ0 */
    IOPORT_NOISE_FILTER_IRQ_PS1_OFFSET = 0x02, /* IRQ1 */
    IOPORT_NOISE_FILTER_IRQ_PS2_OFFSET = 0x04, /* IRQ2 */
    IOPORT_NOISE_FILTER_IRQ_PS3_OFFSET = 0x06, /* IRQ3 */
...
{
    IOPORT_NOISE_FILTER_DREQ_P02_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P03_OFFSET = 0x02, /* DREQ1 */
    IOPORT_NOISE_FILTER_DREQ_P06_OFFSET = 0x04, /* DREQ2 */

    IOPORT_NOISE_FILTER_DREQ_P11_OFFSET = 0x06, /* DREQ3 */
    IOPORT_NOISE_FILTER_DREQ_P14_OFFSET = 0x08, /* DREQ4 */
    IOPORT_NOISE_FILTER_DREQ_P15_OFFSET = 0xF0,

    IOPORT_NOISE_FILTER_DREQ_P20_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P21_OFFSET = 0xF0,

    IOPORT_NOISE_FILTER_DREQ_P40_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P41_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P44_OFFSET = 0x00, /* DREQ0 */
    IOPORT_NOISE_FILTER_DREQ_P45_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P46_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P47_OFFSET = 0xF0,

    IOPORT_NOISE_FILTER_DREQ_P74_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P75_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P76_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_P77_OFFSET = 0xF0,

    IOPORT_NOISE_FILTER_DREQ_PB2_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_PB3_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_PB4_OFFSET = 0xF0,
    IOPORT_NOISE_FILTER_DREQ_PB5_OFFSET = 0xF0,

    IOPORT_NOISE_FILTER_DREQ_PC1_OFFSET = 0x00, /* DREQ0 */

    IOPORT_NOISE_FILTER_DREQ_PD1_OFFSET = 0x02, /* DREQ1 */
    IOPORT_NOISE_FILTER_DREQ_PD4_OFFSET = 0x04, /* DREQ2 */
    IOPORT_NOISE_FILTER_DREQ_PD7_OFFSET = 0x06, /* DREQ3 */

    IOPORT_NOISE_FILTER_DREQ_PE2_OFFSET = 0x08, /* DREQ4 */

    IOPORT_NOISE_FILTER_DREQ_PJ3_OFFSET = 0x00, /* DREQ0 */
