...
typedef enum e_sci_uart_flow_control
{
    ...
    SCI_UART_FLOW_CONTROL_HARDWARE_CTSRTS = 8U, ///< Use CTSn_RTSn pin for RTS and CTSn pin for CTS. Available only for some channels on selected MPUs. See the user's manual for channel specific options
