...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t CPG_CLKON_VCPL4;
        struct
        {
            __IOM uint32_t CLK0_ON    : 1;
            uint32_t                  : 15;
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t CLK9_ON     : 1;
            uint32_t                   : 9;
            __IOM uint32_t CLK3_ON_WEN : 1;
            uint32_t                   : 5;
            __IOM uint32_t CLK9_ON_WEN : 1;
            uint32_t                   : 6;
        } CPG_CLKON_MBUS_b;
    };
    __IM uint8_t RESERVED17[32];
    union
    {
    ...
    union
    {
        __IM uint32_t CPG_CLKMON_VCPL4;
        struct
        {
            __IM uint32_t CLK0_MON : 1;
            uint32_t               : 31;
    ...
    union
    {
        __IOM uint32_t CPG_RSTMON_3DGE;
        struct
        {
            __IOM uint32_t RST0_MON : 1;
            __IOM uint32_t RST1_MON : 1;
    ...
    union
    {
        __IOM uint32_t CPG_RSTMON_VCPL4;
        struct
        {
            __IOM uint32_t RST0_MON : 1;
            __IOM uint32_t RST1_MON : 1;
