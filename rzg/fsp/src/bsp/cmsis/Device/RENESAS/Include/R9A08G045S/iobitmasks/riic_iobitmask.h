...
#define R_RIIC0_ICMR3_SMBE_Msk       (0x80UL)
...
#define R_RIIC0_ICSER_SAR0_Msk       (0x01UL)
#define R_RIIC0_ICSER_SAR0_Pos       (0UL)
#define R_RIIC0_ICSER_SAR1_Msk       (0x02UL)
#define R_RIIC0_ICSER_SAR1_Pos       (1UL)
#define R_RIIC0_ICSER_SAR2_Msk       (0x04UL)
#define R_RIIC0_ICSER_SAR2_Pos       (2UL)
#define R_RIIC0_ICSER_GCE_Msk        (0x08UL)
...
#define R_RIIC0_ICSAR0_SVA0_Msk      (0x01UL)
#define R_RIIC0_ICSAR0_SVA0_Pos      (0UL)
#define R_RIIC0_ICSAR0_SVA_Msk       (0xFEUL)
#define R_RIIC0_ICSAR0_SVA_Pos       (1UL)
#define R_RIIC0_ICSARU0_FS_Msk       (0x01UL)
#define R_RIIC0_ICSARU0_FS_Pos       (0UL)
#define R_RIIC0_ICSARU0_SVA_Msk      (0x06UL)
#define R_RIIC0_ICSARU0_SVA_Pos      (1UL)
#define R_RIIC0_ICSAR1_SVA0_Msk      (0x01UL)
#define R_RIIC0_ICSAR1_SVA0_Pos      (0UL)
#define R_RIIC0_ICSAR1_SVA_Msk       (0xFEUL)
#define R_RIIC0_ICSAR1_SVA_Pos       (1UL)
#define R_RIIC0_ICSARU1_FS_Msk       (0x01UL)
#define R_RIIC0_ICSARU1_FS_Pos       (0UL)
#define R_RIIC0_ICSARU1_SVA_Msk      (0x06UL)
#define R_RIIC0_ICSARU1_SVA_Pos      (1UL)
#define R_RIIC0_ICSAR2_SVA0_Msk      (0x01UL)
#define R_RIIC0_ICSAR2_SVA0_Pos      (0UL)
#define R_RIIC0_ICSAR2_SVA_Msk       (0xFEUL)
#define R_RIIC0_ICSAR2_SVA_Pos       (1UL)
#define R_RIIC0_ICSARU2_FS_Msk       (0x01UL)
#define R_RIIC0_ICSARU2_FS_Pos       (0UL)
#define R_RIIC0_ICSARU2_SVA_Msk      (0x06UL)
#define R_RIIC0_ICSARU2_SVA_Pos      (1UL)
