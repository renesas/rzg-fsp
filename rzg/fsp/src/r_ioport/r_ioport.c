...
/*******************************************************************************************************************//**
 * This API function has NOT been supported because RZ/G does not have an ELC.
 *
                                    ...
                                    ioport_ethernet_mode_t    mode)
{
    ...
    mask  = channel >> IOPORT_PRV_POS_ALIGN_4BIT;
    shift = channel >> (IOPORT_PRV_POS_ALIGN_4BIT + 1);
