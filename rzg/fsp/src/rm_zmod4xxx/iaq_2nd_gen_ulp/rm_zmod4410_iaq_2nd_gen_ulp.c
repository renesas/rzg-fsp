...
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_open(rm_zmod4xxx_ctrl_t * const      p_api_ctrl,
                                                  rm_zmod4xxx_cfg_t const * const p_cfg);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_measurement_start(rm_zmod4xxx_ctrl_t * const p_api_ctrl);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_measurement_stop(rm_zmod4xxx_ctrl_t * const p_api_ctrl);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_status_check(rm_zmod4xxx_ctrl_t * const p_api_ctrl);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_read(rm_zmod4xxx_ctrl_t * const     p_api_ctrl,
                                                  rm_zmod4xxx_raw_data_t * const p_raw_data);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_temperature_and_humidity_set(rm_zmod4xxx_ctrl_t * const p_api_ctrl,
                                                                          float                      temperature,
                                                                          float                      humidity);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_iaq_1st_gen_data_calculate(rm_zmod4xxx_ctrl_t * const         p_api_ctrl,
                                                                        rm_zmod4xxx_raw_data_t * const     p_raw_data,
...
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_odor_data_calculate(rm_zmod4xxx_ctrl_t * const      p_api_ctrl,
                                                                 rm_zmod4xxx_raw_data_t * const  p_raw_data,
                                                                 rm_zmod4xxx_odor_data_t * const p_zmod4xxx_data);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_sulfur_odor_data_calculate(
    rm_zmod4xxx_ctrl_t * const             p_api_ctrl,
    rm_zmod4xxx_raw_data_t * const         p_raw_data,
    rm_zmod4xxx_sulfur_odor_data_t * const p_zmod4xxx_data);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_oaq_1st_gen_data_calculate(rm_zmod4xxx_ctrl_t * const         p_api_ctrl,
                                                                        rm_zmod4xxx_raw_data_t * const     p_raw_data,
                                                                        rm_zmod4xxx_oaq_1st_data_t * const p_zmod4xxx_data);
static fsp_err_t rm_zmod4410_iaq_2nd_gen_ulp_oaq_2nd_gen_data_calculate(rm_zmod4xxx_ctrl_t * const         p_api_ctrl,
                                                                        rm_zmod4xxx_raw_data_t * const     p_raw_data,
 ...
 *********************************************************************************************************************/
rm_zmod4xxx_api_t const g_zmod4xxx_on_zmod4410_iaq_2nd_gen_ulp =
{
    .open                      = rm_zmod4410_iaq_2nd_gen_ulp_open,
    .close                     = rm_zmod4410_iaq_2nd_gen_ulp_close,
    .measurementStart          = rm_zmod4410_iaq_2nd_gen_ulp_measurement_start,
    .measurementStop           = rm_zmod4410_iaq_2nd_gen_ulp_measurement_stop,
    .statusCheck               = rm_zmod4410_iaq_2nd_gen_ulp_status_check,
    .read                      = rm_zmod4410_iaq_2nd_gen_ulp_read,
    .iaq1stGenDataCalculate    = rm_zmod4410_iaq_2nd_gen_ulp_iaq_1st_gen_data_calculate,
    .iaq2ndGenDataCalculate    = rm_zmod4410_iaq_2nd_gen_ulp_data_calculate,
    .odorDataCalculate         = rm_zmod4410_iaq_2nd_gen_ulp_odor_data_calculate,
    .sulfurOdorDataCalculate   = rm_zmod4410_iaq_2nd_gen_ulp_sulfur_odor_data_calculate,
                                                   ...
                                                   rm_zmod4xxx_cfg_t const * const p_cfg)
{
    ...
    p_lib->temperature = RM_ZMOD4410_IAQ_2ND_GEN_ULP_DEFAULT_TEMPERATURE;
    p_lib->humidity    = RM_ZMOD4410_IAQ_2ND_GEN_ULP_DEFAULT_HUMIDITY;

    /* Initialize the library */
    lib_err = init_iaq_2nd_gen_ulp(p_handle);
...
/*******************************************************************************************************************//**
 * @brief  Calculate the IAQ 2nd Gen. ULP data with the library API.
 *
