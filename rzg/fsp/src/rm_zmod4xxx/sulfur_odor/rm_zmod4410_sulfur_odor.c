...
static fsp_err_t rm_zmod4410_sulfur_odor_odor_data_calculate(rm_zmod4xxx_ctrl_t * const      p_api_ctrl,
                                                             rm_zmod4xxx_raw_data_t * const  p_raw_data,
...
static fsp_err_t rm_zmod4410_sulfur_odor_oaq_1st_gen_data_calculate(rm_zmod4xxx_ctrl_t * const         p_api_ctrl,
                                                                    rm_zmod4xxx_raw_data_t * const     p_raw_data,
...
rm_zmod4xxx_api_t const g_zmod4xxx_on_zmod4410_sulfur_odor =
{
    ...
    .odorDataCalculate         = rm_zmod4410_sulfur_odor_odor_data_calculate,
